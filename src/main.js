...
const baseCatalog = {
  products: [
    ...
    },
    {
      ...
      name: 'Catfish Pepper Soup (Head)',
      category: 'pepper_soup',
      priceNaira: 4000,
      recipe: { catfish_head: 1, pepper_soup_portion: 1 },
    },
    {
      id: 'catfish_pepper_soup_center_tail_3500',
      name: 'Catfish Pepper Soup (Center + Tail)',
      category: 'pepper_soup',
      priceNaira: 3500,
    ...
    {
      id: 'fendo_veggie_noodles_with_turkey',
      name: 'Fendo Veggie Noodles + Turkey',
      category: 'sides',
      priceNaira: 7500,
