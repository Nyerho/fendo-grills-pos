...
const baseCatalog = {
  products: [
    {
      id: 'fendo_grilltendo',
      name: 'Fendo Grilltendo',
      category: 'grilltendo_specials',
      priceNaira: 9500,
      recipe: { fish_portion: 1, noodles_pack: 1, hotdog: 1 },
    },
    {
      id: 'ultimate_grilltendo',
      name: 'Ultimate Grilltendo',
      category: 'grilltendo_specials',
      priceNaira: 12500,
      recipe: { fish_portion: 1, noodles_pack: 1, hotdog: 1, turkey_wings_piece: 1 },
    },
    {
      id: 'barbecue_cat_fish',
      name: 'Barbecue Cat Fish',
      category: 'grilltendo_specials',
      priceNaira: 7000,
    ...
    {
      id: 'bole_fish_jutsu',
      name: 'Bole Fish Jutsu',
      category: 'grilltendo_specials',
      priceNaira: 8500,
      recipe: { plantain_portion: 1, fish_portion: 1, pepper_sauce_portion: 1 },
    },
    {
      id: 'attack_on_plantain',
      name: 'Attack On Plantain',
      category: 'grilltendo_specials',
      priceNaira: 3000,
      recipe: { plantain_portion: 1, pepper_sauce_portion: 1 },
    },
    {
      id: 'fendo_chicken_shawarma_main',
      name: 'Fendo Chicken Shawarma Main',
      category: 'shawarma',
      priceNaira: 6000,
      recipe: { shawarma_bread: 1, shawarma_filling_portion: 2 },
    },
    {
      id: 'fendo_beef_shawarma_main',
      name: 'Fendo Beef Shawarma Main',
      category: 'shawarma',
      priceNaira: 6000,
      recipe: { shawarma_bread: 1, shawarma_filling_portion: 2 },
    },
    {
      id: 'mini_chicken_shawarma',
      name: 'Mini Chicken Shawarma',
      category: 'shawarma',
      priceNaira: 4000,
      recipe: { shawarma_bread: 1, shawarma_filling_portion: 1 },
    },
    {
      id: 'mini_beef_shawarma',
    ...
    {
      id: 'fendo_special_suya_shawarma',
      name: 'Fendo Special Suya Shawarma',
      category: 'shawarma',
      priceNaira: 6500,
      recipe: { shawarma_bread: 1, shawarma_filling_portion: 2, suya_spice: 1 },
    },
    {
      id: 'veggie_noodles_and_egg',
      name: 'Veggie Noodles And Egg',
      category: 'veggie_noodles',
      priceNaira: 2000,
      recipe: { noodles_pack: 1, veggies_portion: 1, egg_unit: 1 },
    },
    {
      id: 'noodles_with_turkey',
      name: 'Noddles With Turkey',
      category: 'veggie_noodles',
      priceNaira: 7500,
      recipe: { noodles_pack: 1, turkey_portion: 1, veggies_portion: 1 },
    },
    {
      id: 'hotdog_noodles',
      name: 'Hotdog',
    ...
    },
    {
      ...
      priceNaira: 3500,
      recipe: { goat_meat_portion: 1, pepper_soup_portion: 1 },
    },
    {
      id: 'white_rice',
      name: 'White Rice',
    ...
    },
    {
      ...
      category: 'bole_chops',
      priceNaira: 500,
      recipe: { salad_portion: 1, mayo_portion: 1 },
    },
    {
      id: 'plastic_bag',
      name: 'Plastic Bag',
  ...
  materials: [
    ...
    { id: 'salad_portion', name: 'Salad', unit: 'portion', lowStockThreshold: 10 },
    { id: 'mayo_portion', name: 'Mayo', unit: 'portion', lowStockThreshold: 10 },
    { id: 'plastic_bag_unit', name: 'Plastic Bag', unit: 'pcs', lowStockThreshold: 20 },
    ...
    { id: 'plantain_fried_portion', name: 'Plantain (Dodo)', unit: 'portion', lowStockThreshold: 10 },
    ...
    { id: 'water_bottle', name: 'Water', unit: 'bottle', lowStockThreshold: 10 },
...
function renderPOS() {
  ...
  const sections = [
    { id: 'grilltendo_specials', name: 'Fendo Grilltendo & Barbecue Specials' },
    { id: 'shawarma', name: 'Fendo Shawarma' },
    { id: 'veggie_noodles', name: 'Fendo Veggie Noodles' },
    { id: 'proteins', name: 'Proteins' },
    { id: 'pepper_soups', name: 'Fendo Pepper Soups (White Rice) + Sauce' },
    { id: 'bole_chops', name: 'Bole And Chops' },
    { id: 'drinks', name: 'Drinks + Cocktails + Smoothies' },
  ]

  const byCategory = new Map(sections.map((s) => [s.id, []]))
  for (const p of products) {
    const categoryId = p.category || 'grilltendo_specials'
